class Hive < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/Hivemine-Technologies/hive-releases/releases/download/v0.1.0/hive-aarch64-apple-darwin.tar.xz"
    sha256 "d2e4c9959159cf501c34f738f66174ae17b0de28af88b4a0c49d3e0af77cb36d"
  end
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/Hivemine-Technologies/hive-releases/releases/download/v0.1.0/hive-x86_64-unknown-linux-gnu.tar.xz"
